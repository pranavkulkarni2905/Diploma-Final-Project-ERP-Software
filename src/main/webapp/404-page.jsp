...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="app-assets/css/pages/page-404.min.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="images/error-2.png" class="bg-image-404" alt="">
      <h1 class="error-code m-0">404</h1>
      <h6 class="mb-2">BAD REQUEST</h6>
      
      <%try{
			Integer msg1 = (Integer) session.getAttribute("admin-login");
			if (msg1==404) {
			%>
				<a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="admin/admin-login.jsp">Back
        TO Home</a>
			<%
			}
