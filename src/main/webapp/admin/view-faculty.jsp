		...
		<div class="row">
					...
					<div class="row">
						...
						<div class="col s12 m6 l6 right-align-md">
							<ol class="breadcrumbs mb-0">
								...
								<li class="breadcrumb-item active">Faculties List</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="col s12">
                ...
                if(rs.getString(8)==null){
                	...
                	%>
                	 <span class="avatar-status avatar-online"><img src="../faculty-images/<%=rs.getString(8) %>" alt="avatar"></span>
                	<% 
                }
                %>
													</td>
                ...
                %></td>
													<td><a href=""><i class="material-icons">delete</i></a>
													</td>
